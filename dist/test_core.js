...
const snowflake_js_1 = require("./core/services/snowflake.js");
const base62_js_1 = require("./core/services/base62.js");
const snowflake = new snowflake_js_1.Snowflake(1, 1);
...
const encoded = base62_js_1.Base62.encode(originalId);
const decoded = base62_js_1.Base62.decode(encoded);
...
const shortCode = base62_js_1.Base62.encode(realId);
